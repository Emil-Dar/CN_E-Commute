...
public class OperatorAccountActivity extends AppCompatActivity {
    ...
    private static final String TAG = "OperatorAccountActivity";
        ...
        db.collection("users").document(user.getUid())
                ...
                .addOnSuccessListener(document -> {
                    if (document.exists()) {
                        ...
                        Log.d(TAG, "userType from firestore: " + userType);
                        if (!"Operator".equals(userType)) {
                            Toast.makeText(this, "Not an operator account", Toast.LENGTH_SHORT).show();
                            return;
                        }
                ...
                .addOnFailureListener(e -> Toast.makeText(this, "Failed to load operator profile", Toast.LENGTH_SHORT).show());
    }
    ...
    private void saveOperatorData() {
        ...
        db.collection("users").document(user.getUid())
                .get()
                .addOnSuccessListener(document -> {
                    if (document.exists() && "Operator".equals(document.getString("userType"))) {
                        db.collection("users").document(user.getUid())
                                .update(updates)
